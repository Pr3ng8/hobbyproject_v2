    ...
    <div class="row my-2 mx-1 justify-content-center position-relative">
        ...
        <div class="col-lg-5 my-2 col-md-10 col-sm-10 col-xs-12 col-content p-2 align-self-center ">
            <figure class="figure mx-auto d-block ">
                <!-- Image of the boat -->
                <img src="{{ isset($boat->photos['file']) ? asset($boat->photos['file']) : 'https://via.placeholder.com/350x150'  }}" class="img-figure img-fluid rounded mx-auto d-block" id="boatProfilePicture" alt="A picture of the boat.">
                <!-- -->
        ...
        <div class="col-lg-5 my-2 col-md-10 col-sm-10 col-xs-12 col-content p-2 offset-lg-1 offset-md-0 offset-sm-0 offset-xs-0">
            ...
            <form action="{{ action([App\Http\Controllers\AdminBoatsController::class,'update'], [ 'id' => $boat->id ] ) }}" method="POST">
